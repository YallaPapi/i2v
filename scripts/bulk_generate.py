...
def main():
    ...
    if args.list_models:
        ...
        print("=" * 70)
        print("\n--- WAN MODELS ---")
        print("wan        480p: $0.05/s ($0.25/5s, $0.50/10s)")
        print("           720p: $0.10/s ($0.50/5s, $1.00/10s)")
        print("          1080p: $0.15/s ($0.75/5s, $1.50/10s)")
        print("")
        print("wan21      480p: $0.20/video (flat rate)")
        print("           720p: $0.40/video (flat rate)")
        print("")
        print("wan22      480p: $0.04/s ($0.20/5s, $0.40/10s)")
        print("           580p: $0.06/s ($0.30/5s, $0.60/10s)")
        print("           720p: $0.08/s ($0.40/5s, $0.80/10s)")
        print("")
        print("wan-pro   1080p: $0.16/s ($0.80/5s, $1.60/10s)")
        print("")
        print("--- KLING MODEL ---")
        print("kling      All:  $0.35/5s + $0.07/extra second")
        print("                 5s=$0.35, 10s=$0.70, 15s=$1.05, 30s=$2.10")
        print("")
        print("--- GOOGLE VEO MODELS ---")
        print("veo2       720p: $0.50/s ($2.50/5s, $4.00/8s)")
        print("")
        print("veo31-fast All:  $0.10/s (no audio), $0.15/s (with audio)")
        print("                 6s no audio=$0.60, 6s audio=$0.90")
        print("")
        print("veo31      All:  $0.20/s (no audio), $0.40/s (with audio)")
        print("                 6s no audio=$1.20, 6s audio=$2.40")
        print("")
        print("veo31-flf       $0.20/s - First/Last Frame (needs 2 images)")
        print("veo31-fast-flf  $0.10/s - First/Last Frame Fast (needs 2 images)")
        print("")
        print("--- CHEAPEST OPTIONS (5s video) ---")
        print("1. wan22 480p    = $0.20")
        print("2. wan21 480p    = $0.20")
        print("3. wan 480p      = $0.25")
        print("4. kling         = $0.35")
        print("5. veo31-fast    = $0.60 (6s)")
        print("=" * 70)
        return
